...
public class EcoleController implements Initializable {
    ...
    @FXML private TextField txtNumEcole;
    @FXML private TextField txtDesign;
    @FXML private TextField txtAdresse;
    @FXML private TableView<Ecole> tableEcoles;
    @FXML private TableColumn<Ecole, String> colNum;
    @FXML private TableColumn<Ecole, String> colDesign;
    ...
    @FXML private void handleAjouter() {
        service.ajouter(new Ecole(txtNumEcole.getText(), txtDesign.getText(), txtAdresse.getText()));
        refresh(); handleClear();
    }
    @FXML private void handleModifier() {
        service.modifier(new Ecole(txtNumEcole.getText(), txtDesign.getText(), txtAdresse.getText()));
        refresh();
    }
    @FXML private void handleSupprimer() {
        service.supprimer(txtNumEcole.getText());
        refresh(); handleClear();
    }
    @FXML private void handleClear() {
        txtNumEcole.clear(); txtDesign.clear(); txtAdresse.clear();
    }
