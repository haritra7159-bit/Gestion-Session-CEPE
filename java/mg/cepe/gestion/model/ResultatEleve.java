...
public class ResultatEleve {
    ...
    private double moyenne, totalPondere;
    ...
    public String getNomEcole(){return nomEcole;} public void setNomEcole(String v){this.nomEcole=v;}
    public double getMoyenne(){return moyenne;} public void setMoyenne(double v){this.moyenne=v;}
    public double getTotalPondere(){return totalPondere;} public void setTotalPondere(double v){this.totalPondere=v;}
    public int getTotalCoef(){return totalCoef;} public void setTotalCoef(int v){this.totalCoef=v;}
    public String getDecision(){return decision;} public void setDecision(String v){this.decision=v;}
    public boolean isAdmisSixieme(){return admisSixieme;} public void setAdmisSixieme(boolean v){this.admisSixieme=v;}
