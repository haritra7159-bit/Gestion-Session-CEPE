...
public class NoteServiceImpl implements NoteService {
    ...
    @Override public List<Note> listerParEleve(String e){return dao.findByEleve(e);}
    @Override public boolean aDesNotes(String e){return !dao.findByEleve(e).isEmpty();}
    @Override public List<String> listerAnnees(){return dao.findDistinctAnnees();}
}
