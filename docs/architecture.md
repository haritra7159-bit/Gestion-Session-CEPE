...
Règles : `moyenne = SUM(note × coefficient) / SUM(coefficient)` ; admis CEPE si moyenne `>= 9,75` ; admis en 6e si moyenne `> 12` ; une note est unique par année, élève et matière.
